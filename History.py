...
# Data untuk tabel
data = [
    ['Tansformator 1', '24-03-2022', 'DPM', '7', '5', '9', '12', '24', 'D1', 'Titik X= 0.98765 dan Y=0.23456', 'Sela Aulia'],
    ['Tansformator 1', '23-03-2022', 'DTM', ' ', '5', '9', '12', ' ', 'D1', 'Titik X= 0.98765 dan Y=0.23456', 'Sela Aulia'],
    ['Tansformator 1', '22-03-2022', 'DPM', '7', '5', '9', '12', '24', 'D1', 'Titik X= 0.98765 dan Y=0.23456', 'Sela Aulia'],
    ['Tansformator 1', '21-03-2022', 'DTM', ' ', '5', '9', '12', ' ', 'D1', 'Titik X= 0.98765 dan Y=0.23456', 'Sela Aulia'],
    ['Tansformator 1', '20-03-2022', 'DPM', '7', '5', '9', '12', '24', 'D1', 'Titik X= 0.98765 dan Y=0.23456', 'Sela Aulia']
]
# Layout tabel
table_layout = [
    [sg.Table(values=data, headings=['Transformator', 'Tanggal', 'Metode', 'H2', 
                                     'CH4', 'C2H2', 'C2H4', 'C2H6', 'Titik Kerusakan',
                                     'Deskripsi', 'Penguji'], num_rows=5, col_widths=[15, 5, 20], justification='c')]
]
